...
public static class VectorMath
{
    ...
    /// <summary>
    /// This method calculates the dot product of two double arrays (vectors) of equal length.
    /// The method checks if the lengths of the input vectors are within the valid range (2-3) and if they are equal.
    /// If the input vectors do not meet these conditions, the method returns -1 to indicate an error.
    /// </summary>
    /// <param name="vector1">The first double array representing a 2D or 3D vector.</param>
    /// <param name="vector2">The second double array representing a 2D or 3D vector.</param>
    /// <returns>The dot product of the input vectors, or -1 to indicate an error.</returns>
    /// <exception cref="ArgumentException">Thrown when the lengths of the input vectors are outside the valid range (2-3) or when they are not equal.</exception>
